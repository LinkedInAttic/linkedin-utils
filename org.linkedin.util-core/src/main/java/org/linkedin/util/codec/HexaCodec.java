...
/**
 * Simply returns the hexadecimal values of the byte array.
 *
 * @author ypujante@linkedin.com
 *
 */
public class HexaCodec implements Codec
{
  // stateless, thread safe..
  public static final HexaCodec INSTANCE = new HexaCodec();

  public static HexaCodec instance()
  {
    return INSTANCE;
  }

  private static String[] HEXA_VALUES =
    {
   ...
   * @throws CannotDecodeException if the string has not been encoded with this codec
   */
  @Override
  public byte[] decode(String s) throws CannotDecodeException
  {
    ...
    {
      throw new CannotDecodeException("Cannot decode null or empty String");
    }
    else
    {
